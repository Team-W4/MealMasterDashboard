...
export const getAllStock = () => dispatch => {
  ...
  StockService.getAllStock().then(foodStocks =>
    dispatch(receiveStock(foodStocks)),
  );
};
...
export const getFoodStockByFood = foodId => dispatch => {
  ...
  StockService.getFoodStockByFood(foodId).then(foodStock =>
    dispatch(receiveFoodStock(foodStock)),
  );
};
...
export const getFoodStockById = stockId => dispatch => {
  ...
  StockService.getFoodStockById(stockId).then(foodStock =>
    dispatch(receiveFoodStock(foodStock)),
  );
};
...
export const getStockItemById = stockItemId => dispatch => {
  ...
  StockService.getStockItemById(stockItemId).then(stockItem =>
    dispatch(receiveStockItem(stockItem)),
  );
};
...
export const updateStockItem = stockItemData => dispatch => {
  ...
  StockService.updateStockItem(stockItemData).then(stockItem =>
    dispatch(receiveStockItem(stockItem)),
  );
};
